            ...
            {!session ? (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 xl:px-6 py-2.5 text-sm xl:text-base font-semibold rounded-lg transition-all duration-200 whitespace-nowrap bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
                >
                ...
                <Link
                  href="/admin/signin"
                  className="px-3 xl:px-4 py-2 text-xs xl:text-sm font-medium rounded-lg transition-all duration-200 border whitespace-nowrap border-gray-300 text-gray-600 hover:bg-gray-50 hover:border-gray-400 hover:text-gray-700"
                >
                  Admin
                </Link>
              </div>
